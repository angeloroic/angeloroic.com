...
export const croatianContent: SiteContent = {
  ...
  services: {
    ...
    areas: [
      ...
      { title: "WEB DEVELOPMENT", items: ["HTML", "CSS", "JavaScript", "Responzivni web razvoj", "WordPress", "Web performanse", "Git/GitHub"] },
      { title: "AI & AGENTIC WORKFLOWS", items: ["Razvoj uz pomoć AI-ja", "AI agenti", "Agentic workflows", "Automatizacija", "Istraživački radni tokovi", "Podatkovni radni tokovi"] },
  ...
  experience: {
    label: "Iskustvo",
    entries: [
      { dates: "2012 → 2017", role: "Samostalni digitalni marketer", description: "Počeo sam s affiliate marketingom, YouTubeom, SEO-om i WordPressom, izrađujući i pozicionirajući web-stranice prije dubljeg ulaska u plaćeno oglašavanje." },
      ...
      { dates: "2024 → 2025", role: "Affiliate Manager", company: "LeadX Pro", description: "Affiliate management, kvaliteta prometa, izvedba kampanja i skaliranje u više vertikala performance marketinga." },
      ...
      { dates: "2026 → danas", role: "Specijalist za regrutaciju", company: "AffPal", description: "Regrutacija i procjena kandidata za tvrtke usmjerene na rezultate, uz primjenu opsežnog iskustva u affiliate i digital marketing industriji." },
    ],
  },
