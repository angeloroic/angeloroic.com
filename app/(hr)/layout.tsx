...
export const metadata: Metadata = {
  ...
  description: "14+ godina iskustva u digitalnom marketingu, danas povezano s modernim web developmentom i AI automatizacijom za izradu pametnijih digitalnih proizvoda.",
